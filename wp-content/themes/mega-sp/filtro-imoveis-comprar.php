...
/**
 * Template Name: Filtro de Imoveis (Comprar)
 */
  ...
  <header class="main-header mob">
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <div class="tab-navigation type-filter">
              <ul class="nav nav-pills" id="pills-tab" role="tablist">
                <!-- Form Trigger -->
                <li class="nav-item">
                  <a class="custom-pill imoveis-pill active" href="<?php echo get_bloginfo( 'wpurl' );?>/imoveis/comprar">Comprar</a>
                </li>
                <!-- WhatsApp Trigger -->
                <li class="nav-item">
    ...
    ?>
                    ...
                    <div class="no-results-holder">
                        ...
                        <a href="<?php echo get_bloginfo( 'wpurl' );?>/imoveis/comprar" class="btn neutral-btn">Limpar Filtro</a>
                      </div>
                        <?php
                    endif; ?>
