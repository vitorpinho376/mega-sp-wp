<?php
/**
 * Template Name: Filtro de Negocios (Franquias)
 */
get_header(); ?>
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <div class="tab-navigation type-filter">
              <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <!-- WhatsApp Trigger -->
                <li class="nav-item">
                  <a class="custom-pill negocios-pill" href="<?php echo get_bloginfo( 'wpurl' );?>/negocios/passo-o-ponto">Passo o Ponto</a>
                </li>
                <!-- Phone Trigger -->
                <li class="nav-item">
                  <a class="custom-pill negocios-pill active" href="<?php echo get_bloginfo( 'wpurl' );?>/negocios/franquias">Franquias</a>
                </li>
              </ul>
            </div>
            ...
            if(isset($_GET['negociomax_fat'])){
                ...
                if(isset($_GET['funcionarios'])){
                   ...
                   // Query Imóveis Novos
                   $franqnegocios_query = new WP_Query( array(
                      'post_type' => 'negocio',
                ...
                <div class="row">
                  ...
                  if ($franqnegocios_query -> have_posts() ) :
                  while ($franqnegocios_query -> have_posts()) : $franqnegocios_query -> the_post();
                ...
                <div class="no-results-holder">
                    ...
                    <a href="<?php echo get_bloginfo( 'wpurl' );?>/negocios/franquias" class="btn neutral-btn">Limpar Filtro</a>
                  </div>
                    <?php
                endif; ?>
