...
/**
 * Template Name: Filtro de Imoveis (Novos)
 */
  ...
  <header class="main-header mob">
          ...
          <div class="col-md-4 desk">
            ...
            <div class="filter-card-block">
              ...
              <div class="filter-block-content">
                ...
                <div class="checkbox-group">
                  <input class="imoveis-check" name="tipo_de_imovel[residencial]" value="residencial" type="checkbox" <?php echo isset($_GET['residencial_ou_comercial']) && isset($_GET['residencial_ou_comercial'][residencial]) ? 'checked' : '' ?>>
                  <label>Residencial</label>
                </div>
                <div class="checkbox-group">
                  <input class="imoveis-check" name="tipo_de_imovel[comercial]" value="comercial" type="checkbox" <?php echo isset($_GET['residencial_ou_comercial']) && isset($_GET['residencial_ou_comercial'][comercial]) ? 'checked' : '' ?>>
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <div class="tab-navigation type-filter">
              <ul class="nav nav-pills" id="pills-tab" role="tablist">
                ...
                <!-- WhatsApp Trigger -->
                <li class="nav-item">
                  <a class="custom-pill imoveis-pill" href="<?php echo get_bloginfo( 'wpurl' );?>/imoveis/alugar">Alugar</a>
                </li>
                <!-- Phone Trigger -->
                <li class="nav-item">
                  <a class="custom-pill imoveis-pill active" href="<?php echo get_bloginfo( 'wpurl' );?>/imoveis/imoveis-novos">Imóveis Novos</a>
                </li>
              </ul>
            </div>
              ...
              <div class="container-fluid">
                ...
                if(isset($_GET['numero_de_quartos'])){
                  ...
                  if(isset($_GET['numero_de_banheiros'])){
                    ...
                    //Tipo de Imóvel
                    if(isset($_GET['residencial_ou_comercial'])){
                        $tipo_de_imovel[residencial] = $_GET['residencial_ou_comercial'];
                        if($tipo_de_imovel[residencial] == residencial){
                            array_push($meta_query, [
                                'key' => 'residencial_ou_comercial',
                                'value' => 'residencial'
                            ]);
                        }
                        if($tipo_de_imovel[comercial] == comercial){
                            array_push($meta_query, [
                              'key' => 'residencial_ou_comercial',
                              'value' => 'comercial'
                            ]);
              ...
              <div class="row">
                ...
                if ($aluguelimoveis_query -> have_posts() ) :
    ...
    ?>
                    ...
                    <div class="no-results-holder">
                        ...
                        <h3>Imóveis não encontrados</h3>
                        <p>Não conseguimos encontrar nenhum imóvel com essas especificações. Limpe o seu filtro e comece novamente.</p>
                        <a href="<?php echo get_bloginfo( 'wpurl' );?>/imoveis/imoveis-novos" class="btn neutral-btn">Limpar Filtro</a>
                      </div>
                        <?php
                    endif; ?>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Filtre Imóveis</h4>
