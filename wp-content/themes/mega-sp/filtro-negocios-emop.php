<?php
/**
 * Template Name: Filtro de Negocios (Em Operacao)
 */
get_header(); ?>
          ...
          <div class="col-md-8 col-sm-12">
            ...
            if(isset($_GET['negociomax_fat'])){
                ...
                <div class="row">
                  ...
                  if ($opnegocios_query -> have_posts() ) :
                  while ($opnegocios_query -> have_posts()) : $opnegocios_query -> the_post();
                ...
                <div class="no-results-holder">
                    ...
                    <a href="<?php echo get_bloginfo( 'wpurl' );?>/negocios/em-operacao" class="btn neutral-btn">Limpar Filtro</a>
                  </div>
                    <?php
                endif; ?>
